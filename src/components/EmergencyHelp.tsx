...
export const EmergencyHelp: React.FC = () => {
  ...
  return (
    <section id="emergency" className="py-16 sm:py-24 bg-gradient-to-b from-[#0B1F2A] via-[#0A1B25] to-[#081620] transition-colors relative overflow-hidden border-y border-[#3FCDA8]/20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto bg-[#0F2836] text-[#F7F3E9] rounded-3xl p-8 sm:p-12 shadow-2xl border border-rose-500/40 relative overflow-hidden space-y-8">
          
          {/* Glowing background aura */}
          <div className="absolute top-0 right-0 w-80 h-80 bg-rose-500/10 rounded-full blur-3xl pointer-events-none" />

          <div className="space-y-4 relative z-10">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-rose-950/80 border border-rose-800 text-xs font-bold uppercase tracking-wider backdrop-blur-md text-rose-200">
              <ShieldAlert className="w-4 h-4 text-rose-400 animate-pulse" />
              <span>Immediate Support Available 24/7</span>
            </div>

            <h2 className="text-2xl sm:text-4xl font-serif font-bold leading-tight text-[#F7F3E9]">
            ...
            <p className="text-sm sm:text-base text-[#F7F3E9]/80 max-w-2xl font-sans">
              Free, confidential, and compassionate mental health support is available at any time of day or night.
            </p>
          </div>

          {/* Helpline Numbers Box */}
          <div className="bg-[#0B1F2A]/90 backdrop-blur-md p-6 sm:p-8 rounded-2xl border border-[#3FCDA8]/30 space-y-6 relative z-10">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <span className="text-xs font-bold uppercase tracking-wider text-[#3FCDA8]">
                  Government of India Tele-MANAS Helpline
                </span>
                <div className="text-2xl sm:text-4xl font-extrabold font-mono tracking-wider text-[#3FCDA8] mt-1">
                  14416 <span className="text-sm font-sans font-normal text-[#F7F3E9]/70">or</span> 1-800-89-14416
                </div>
                <p className="text-xs text-[#F7F3E9]/70 mt-1">
              ...
              <a
                href="tel:14416"
                className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-gradient-to-r from-rose-500 to-[#F2A65A] hover:brightness-110 text-white font-bold text-base shadow-xl flex items-center justify-center gap-2.5 transition-transform transform hover:scale-105 active:scale-95 flex-shrink-0"
              >
        ...
        <div className="mt-16 max-w-3xl mx-auto bg-[#0F2836] p-8 rounded-3xl border border-[#3FCDA8]/30 shadow-xl space-y-6">
          <div className="text-center space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#0B1F2A] text-[#3FCDA8] border border-[#3FCDA8]/30 text-xs font-bold">
              <LifeBuoy className="w-4 h-4 text-[#3FCDA8]" />
              <span>Instant Panic & Anxiety Grounding</span>
            </div>
            <h3 className="text-2xl font-serif font-bold text-[#F7F3E9]">
              5-4-3-2-1 Grounding Technique
            </h3>
            <p className="text-xs text-[#F7F3E9]/70">
              ...
              <div
                ...
                className={`p-4 rounded-2xl border transition-all cursor-pointer flex items-center justify-between ${
                  activeGroundingStep === idx
                    ? 'border-[#3FCDA8] bg-[#0B1F2A] shadow-md'
                    : 'border-[#3FCDA8]/20 bg-[#0B1F2A]/60 hover:bg-[#0B1F2A]'
                }`}
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-[#0F2836] border border-[#3FCDA8]/30 flex items-center justify-center font-bold text-lg font-mono text-[#3FCDA8] shadow-sm">
                    {step.count}
                  </div>
                  <div>
                    <h4 className="font-bold text-sm text-[#F7F3E9] flex items-center gap-2">
                      {step.title}
                    </h4>
                    <p className="text-xs text-[#F7F3E9]/70">
                      {step.desc}
